...
class UpdateUserProfileCommandTest extends TestCase
{
    /**
    ...
    public function test_construct(): void
    {
        ...
        $command = new UpdateUserProfileCommand($id,  $firstName, $lastName, $email, $password);
        ...
        $this->assertSame($password, $command->getPlainPassword());
    }
}